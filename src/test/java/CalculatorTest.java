...
public class CalculatorTest {
    ...
    public void logTruePositive() {
        ...
        assertEquals("Finding natural log for True Positive", 5.703782474656201, calculator.log(300), DELTA);
    }

    @Test
    public void logTrueNegative() {
        assertNotEquals("Finding natural log for True Negative", 69, calculator.log(2.4), DELTA);
        assertNotEquals("Finding natural log for True Negative", 420, calculator.log(2.1), DELTA);
    }
